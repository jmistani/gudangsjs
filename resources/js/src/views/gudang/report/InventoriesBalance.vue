      ...
      <div class="d-flex justify-content-between align-items-center content-sidebar-header px-2 py-1">
         ...
         >
            <b-row>
               ...
               <b-col cols="12">
                  <b-form-group>
                     <b-form-checkbox v-model="refReport.bygroup" :value=1 :unchecked-value=0>Dalam Grup</b-form-checkbox>
                  </b-form-group>
               </b-col>
               <b-col md="12">
                  <b-form-group>
                     <b-button  type=submit pill size="md" variant="primary">Tampilkan</b-button>
                  </b-form-group>
               </b-col>
            </b-row>
         </b-form>
...
//            WinPrint.document.close();
         ...
         // generatereport() {
         //    this.reportURL = `http://localhost/api/inventory/report/inventory-balance/${this.per_date}`
         // }
    },
  setup(props, { emit }) {
   ...
   const prefilledForm = ref({
    ...
    const onSubmit = () => {
      ...
      refReportURL.value = `https://gudangsjs.serasijayasejati.com/api/inventory/report/inventory-balance/${refReport.value.per_date}/${refReport.value.bygroup}`
    }
