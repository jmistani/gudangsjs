<template>
  <div class="container">
     <b-row class="mx-0">
         <b-col md="12">
            <div class="mb-2">
               <b-button-toolbar class="d-flex justify-content-center" aria-label="Inventory Ticket">
...
export default {
   ...
   mounted() {
      this.ticketID = router.currentRoute.params.id
      this.reportURL = `http://localhost/api/tickets/showPDF/${this.ticketID}`
   },
   methods: {
        /*
