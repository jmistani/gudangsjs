<template>
  <div class="container">
     <b-row>
         <b-col md="12">
            <div class="mb-2">
               <b-button-toolbar class="d-flex justify-content-center" aria-label="Inventory Receive">
...
import {BCard, BCardBody, BButton, BRow, BCol, BAvatar, BTable, BButtonToolbar, BButtonGroup} from 'bootstrap-vue'
...
export default {
   ...
   mounted() {
      this.invReceiveID = router.currentRoute.params.id
      this.reportURL = `https://gudangsjs.serasijayasejati.com/api/inventory-receives/showPDF/${this.invReceiveID}`
   },
   methods: {
        /*
